            ...
            <motion.button
              ...
              className={
                open
                  ...
                  : pomodoro.isRunning
                    ? 'relative flex h-14 min-w-[3.5rem] items-center justify-center rounded-full bg-zinc-900 px-2.5 text-white shadow-lg ring-2 ring-zinc-900/15 transition-transform active:scale-95'
