        ...
        <div className="grid grid-cols-12 items-start gap-5">
          <div className="col-span-12 grid grid-cols-2 gap-4 md:grid-cols-3 xl:col-span-8">
            {habits.map((h, i) => {
              ...
              return (
                <div key={h.id} className="flex aspect-square flex-col border border-zinc-200 p-2">
                  ...
                  <div className="min-h-0 flex-1">
                    <ColorDual a={habitTrend(h, recentWeeks)} b={habitTrend(h, priorWeeks)} color={color} height={180} />
                  </div>
