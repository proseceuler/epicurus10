...
import {
  ...
  MessageSquare, Activity, Tag, AlignLeft, Link2, FileText,
} from 'lucide-react';
      ...
      <div className="epic-glass-sheet relative my-6 w-[min(96vw,52rem)] overflow-visible" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <aside className="relative w-full overflow-visible border-t border-zinc-200/50 p-5 lg:w-64 lg:border-l lg:border-t-0">
            ...
            <h3 className="mb-3 mt-6 text-[11px] font-semibold uppercase tracking-wide text-zinc-400"><MessageSquare className="mr-1 inline h-3.5 w-3.5" /> Comments and activity</h3>
