...
export const ACTION_CATALOG: ActionOp[] = [
  ...
  { domain: 'kanban', op: 'list', tool: 'get_kanban', kind: 'read', page: 'kanban' },
  { domain: 'kanban', op: 'create', tool: 'add_kanban_task', kind: 'write', page: 'kanban' },
  { domain: 'kanban', op: 'move', tool: 'move_kanban_task', kind: 'write', page: 'kanban' },
  ...
  { domain: 'classhub', op: 'attend', tool: 'mark_attendance', kind: 'write', page: 'classhub' },
  ...
  { domain: 'flashcards', op: 'update', tool: 'update_flashcard', kind: 'write', page: 'flashcards' },
  { domain: 'flashcards', op: 'delete', tool: 'delete_flashcard', kind: 'write', page: 'flashcards' },
  { domain: 'habits', op: 'list', tool: 'get_habits', kind: 'read', page: 'habits' },
  { domain: 'habits', op: 'create', tool: 'add_habit', kind: 'write', page: 'habits' },
