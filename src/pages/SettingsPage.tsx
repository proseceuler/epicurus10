      ...
      <div className="space-y-4">
        ...
        <Card className="p-6">
          ...
          <div className="flex items-center justify-between p-3 rounded-xl glass">
            ...
            <Button variant="secondary" size="sm" onClick={exportData}><Download className="w-4 h-4" /> Export</Button>
          </div>
        </Card>
      </div>
    </div>
...
function InstallTip() {
  ...
  return (
    <Card className="p-6">
      <div className="flex items-center gap-2 mb-3"><Smartphone className="w-5 h-5 text-zinc-400" /><h3 className="font-semibold text-zinc-800">Install epicure</h3></div>
      <p className="text-sm text-zinc-500">Add epicure to your home screen for a full-screen, app-like experience.</p>
