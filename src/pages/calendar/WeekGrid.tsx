  ...
  return (
    <div className="overflow-x-auto overscroll-x-contain">
      <div className="min-w-[min(100%,36rem)] sm:min-w-[640px]">
        <div className="week-cols" style={{ gridTemplateColumns: cols }}>
          <div />
          {p.rangeDays.map((d) => {
            const dayIso = iso(d);
        ...
        <div className="week-cols" style={{ gridTemplateColumns: cols, minHeight: allDayOpen ? Math.max(28, allDayLanes * 20 + 8) : 28 }}>
          <button
            type="button"
        ...
        <div ref={scrollerRef} className="week-hours max-h-[min(32rem,calc(100dvh-16rem))]">
          <div className="week-cols" style={{ gridTemplateColumns: cols }}>
