...
/** 2026–2027 class schedule (Mon–Thu 7:00–4:55, Fri 7:00–3:55). Recess/lunch omitted as free periods. */
const DEFAULT_TIMETABLE: Omit<TimetableEntry, 'id'>[] = [
  // Mon–Fri Math & Science
  ...([1, 2, 3, 4, 5] as const).flatMap((d) => [
    { subject_key: 'math', day_of_week: d, start_time: '07:00', end_time: '08:20', room: '' },
    { subject_key: 'science', day_of_week: d, start_time: '08:20', end_time: '09:40', room: '' },
  ]),
  // Mon–Thu Creative Tech, AP, Filipino, Values, English
  ...([1, 2, 3, 4] as const).flatMap((d) => [
    { subject_key: 'creative_tech', day_of_week: d, start_time: '09:55', end_time: '10:55', room: '' },
    { subject_key: 'ap', day_of_week: d, start_time: '10:55', end_time: '11:55', room: '' },
    { subject_key: 'filipino', day_of_week: d, start_time: '12:55', end_time: '13:55', room: '' },
    { subject_key: 'values', day_of_week: d, start_time: '14:55', end_time: '15:55', room: '' },
    { subject_key: 'english', day_of_week: d, start_time: '15:55', end_time: '16:55', room: '' },
  ]),
  // Research Mon–Tue 13:55–14:55; Fri 09:55–11:55
  { subject_key: 'research', day_of_week: 1, start_time: '13:55', end_time: '14:55', room: '' },
  { subject_key: 'research', day_of_week: 2, start_time: '13:55', end_time: '14:55', room: '' },
  { subject_key: 'research', day_of_week: 5, start_time: '09:55', end_time: '11:55', room: '' },
  // MAPEH Wed–Thu 13:55–14:55; Fri 12:55–14:55
  { subject_key: 'mapeh', day_of_week: 3, start_time: '13:55', end_time: '14:55', room: '' },
  { subject_key: 'mapeh', day_of_week: 4, start_time: '13:55', end_time: '14:55', room: '' },
  { subject_key: 'mapeh', day_of_week: 5, start_time: '12:55', end_time: '14:55', room: '' },
];
...
export function TimetableTab() {
  ...
  const loadData = useCallback(async () => {
    ...
    let list = (entryData ?? []) as TimetableEntry[];
    if (list.length === 0) {
      const inserts: TimetableEntry[] = [];
      for (const row of DEFAULT_TIMETABLE) {
        const { data } = await supabase.from('timetable_entries').insert(row).select().single();
        if (data) inserts.push(data as TimetableEntry);
      }
      list = inserts;
    }
    setEntries(list);
